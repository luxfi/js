...
export class Vertex extends Serializable {
  ...
  setCodecID(codecID: number): void {
    ...
    this._typeID =
      this._codecID === 0 ? XVMConstants.VERTEX : XVMConstants.VERTEX_CODECONE
  }
  ...
  /**
   * Class representing a Vertex which is a container for XVM Transactions.
   *
