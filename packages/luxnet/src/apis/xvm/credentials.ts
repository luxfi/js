...
export const SelectCredentialClass = (
  ...
  if (
    credid === XVMConstants.SECPCREDENTIAL ||
    credid === XVMConstants.SECPCREDENTIAL_CODECONE
  ) {
    return new SECPCredential(...args)
  }
  if (
    credid === XVMConstants.NFTCREDENTIAL ||
    credid === XVMConstants.NFTCREDENTIAL_CODECONE
  ) {
...
export class SECPCredential extends Credential {
  ...
  protected _typeID =
    this._codecID === 0
      ? XVMConstants.SECPCREDENTIAL
      : XVMConstants.SECPCREDENTIAL_CODECONE
...
export class NFTCredential extends Credential {
  ...
  protected _typeID =
    this._codecID === 0
      ? XVMConstants.NFTCREDENTIAL
      : XVMConstants.NFTCREDENTIAL_CODECONE
