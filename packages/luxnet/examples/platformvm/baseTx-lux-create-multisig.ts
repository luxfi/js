...
import { GetBalanceResponse } from "lux/dist/apis/xvm/interfaces"
import {
  PrivateKeyPrefix,
...
const memo: Buffer = Buffer.from(
  "XVM manual create multisig BaseTx to send LUX"
)
...
const main = async (): Promise<any> => {
  ...
  const xvmUTXOResponse: any = await pchain.getUTXOs(xAddressStrings)
