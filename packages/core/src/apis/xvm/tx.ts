...
export const SelectTxClass = (txtype: number, ...args: any[]): BaseTx => {
  if (txtype === XVMConstants.BASETX) {
    return new BaseTx(...args)
  } else if (txtype === XVMConstants.CREATEASSETTX) {
    return new CreateAssetTx(...args)
  } else if (txtype === XVMConstants.OPERATIONTX) {
    return new OperationTx(...args)
  } else if (txtype === XVMConstants.IMPORTTX) {
    return new ImportTx(...args)
  } else if (txtype === XVMConstants.EXPORTTX) {
