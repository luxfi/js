...
describe("HDNode", (): void => {
  ...
  const addrs: string[] = [
    "X-lux15qwuklmrfcmfw78yvka9pjsukjeevl4aveehq0",
    "X-lux13wqaxm6zgjq5qwzuyyxyl9yrz3edcgwgfht6gt",
    "X-lux1z3dn3vczxttts8dsdjfgtnkekf8nvqhhsj5stl",
    "X-lux1j6kze9n7r3e8wq6jta5mf6pd3fwnu0v9wygc8p",
    "X-lux1ngasfmvl8g63lzwznp0374myz7ajt4746g750m",
    "X-lux1pr7pzcggtrk6uap58sfsrlnhqhayly2gtlux9l",
    "X-lux1wwtn3gx7ke4ge2c29eg5sun36nyj55u4dle9gn",
    "X-lux13527pvlnxa4wrfgt0h8ya7nkjawqq29sv5s89x",
    "X-lux1gw6agtcsz969ugpqh2zx2lmjchg6npklvp43qq",
    "X-lux10agjetvj0a0vf6wtlh7s6ctr8ha8ch8km8z567"
  ]
