...
// ts-node examples/xvm/buildCreateAssetTx.ts
// if you run the xvm.getAllBalances method you will see the asset alongside LUX, and a balance of 507

const getUTXOIDs = (
  utxoSet: UTXOSet,
  txid: string,
  outputType: number = XVMConstants.SECPXFEROUTPUTID_CODECONE,
...
const memo: Buffer = Buffer.from(
  "XVM utility method buildSECPMintTx to mint an ANT"
)
